...
#                                     type_doc=type_name,
#                                 )
#                                 # doc_prod=ProductDocument(product=new_product,document=doc)
#                                 # doc_prod.save()
...
#                             props =  ProductProperty.objects.filter(product=prod).exists
...
#                                 #     unit_measure=unit_measure,
#                                 # )
#                                 update_change_reason(ProductProperty, "Автоматическое")
#                         except Product.DoesNotExist:
#                             pass
#             except Exception as e: 
#                 print(e)
#                 error = "file_api_error"
#                 location = "Загрузка фаилов IEK"
#                 info = f"ошибка при чтении товара артикул: . Тип ошибки:{e}"
#                 e = error_alert(error, location, info)
#             finally:    
#                 continue 
